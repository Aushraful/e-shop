$(document).ready(function(){
	...
	*/
	...
	/*
		Here #login is login form id and this form is available in index.blade.php page
		...
		used to redirect user from home page to profile.blade.php page
	*/
	...
	*/
	$("body").delegate(".qty","keyup",function(event){
        ...
        if (qty > 15) {
			...
			$('.checkout1').hide();
			$('.checkout2').hide();
            alert('Please input a value between 1 and 15');
        }else {
            $('#update_error').hide();
            $('.update').show();
            $('.checkout1').show();
