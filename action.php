...
if (isset($_POST["Common"])) {
    ...
    if (isset($_POST["checkOutDetails"])) {
        if (mysqli_num_rows($query) > 0) {
                ...
                echo
                    '<div class="row" id="load_cart_products">
								...
								<div class="col-md-2 text-center" style="margin-top: 40px;">
									<div class="btn-group">
										<a update_id="'.$product_id.'" class="btn btn-info update"><i class="fa fa-check" aria-hidden="true"></i>
										<br>Update
										</a>
										<a remove_id="'.$product_id.'" class="btn btn-danger remove"><i class="fa fa-trash" aria-hidden="true"></i>
										<br>Delete</a>
									</div>
								</div>
							</div><br><hr>';
            ...
            if (!isset($_SESSION["uid"])) {
                echo '<input type="submit" style="float:right;" name="login_user_with_product" class="btn btn-info btn-lg checkout1" value="Checkout now" >
							</form>';
                ...
                echo
                    '<input type="hidden" name="return" value="http://localhost/e-shop/payment_success.php"/>
									...
									<input style="float:right;margin-right:80px;" type="image" name="submit" class="checkout2"
